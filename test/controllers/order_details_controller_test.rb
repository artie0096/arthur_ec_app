...
class OrderDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post order_details_url, params: { order_detail: { color: @order_detail.color, regular_price: @order_detail.regular_price, selling_price: @order_detail.selling_price, size: @order_detail.size, stock_quantity: @order_detail.stock_quantity, weight: @order_detail.weight } }
    end
  ...
  test "should update order_detail" do
    patch order_detail_url(@order_detail), params: { order_detail: { color: @order_detail.color, regular_price: @order_detail.regular_price, selling_price: @order_detail.selling_price, size: @order_detail.size, stock_quantity: @order_detail.stock_quantity, weight: @order_detail.weight } }
